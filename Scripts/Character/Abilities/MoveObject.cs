...
namespace Opsive.ThirdPersonController.Abilities
{
    ...
    public class MoveObject : Ability
    {
        ...
        public override bool CanStartAbility()
        {
            ...
            if (m_Controller.Grounded && Physics.Raycast(m_Transform.position + m_Controller.CapsuleCollider.center, m_Transform.forward, out m_RaycastHit, m_StartMoveMaxDistance, m_MoveableLayer.value)) {
