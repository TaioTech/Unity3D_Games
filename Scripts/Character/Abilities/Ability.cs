...
#if UNITY_EDITOR
        /// <summary>
        /// Repurpose OnDrawGizmosSelected so it'll remove the ability if there is no longer a RigidbodyCharacterController. This cannot be done within an inspector
        /// component because the abilities are drawn using the RigidbodyCharacterController's inspector.
        /// </summary>
        private void OnDrawGizmosSelected()
        {
            if (!UnityEditor.EditorApplication.isPlaying && GetComponent<RigidbodyCharacterController>() == null) {
