...
namespace Opsive.ThirdPersonController.Abilities
{
    ...
    public class Dive : Ability
    {
        ...
        public override bool CanStartAbility()
        {
            ...
            RaycastHit hit;
            if (Physics.Raycast(m_Controller.transform.position, -m_Controller.transform.up, out hit, m_MinDiveDepth, LayerManager.Mask.IgnoreInvisibleLayersPlayerWater)) {
                return false;
            }
